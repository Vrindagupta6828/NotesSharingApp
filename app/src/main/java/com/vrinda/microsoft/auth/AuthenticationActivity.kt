    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        forgotPassword.setOnClickListener{
            ...
            dialog.findViewById<Button>(R.id.btnSubmit).setOnClickListener{
                ...
                val mail = dialog.findViewById<EditText>(R.id.editResEmail)
                val email = mail.text.toString()


                if(email.isEmpty()) {
                    mail.error = "Please enter Emailid"
                        ...
                        override fun onDataChange(dataSnapshot: DataSnapshot) {
                            if (dataSnapshot.exists()) {
                                for (ds in dataSnapshot.children) {
                                    ...
                                    //User has already registered through normal EditText so prevent SignUp by google
