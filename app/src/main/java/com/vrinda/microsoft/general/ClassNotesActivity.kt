...
import com.vrinda.microsoft.adapters.ClassNotesAdapter
import com.vrinda.microsoft.auth.AuthenticationActivity
import com.vrinda.microsoft.modals.FileUploadData
    ...
    private fun filter(text: String) {
        ...
        for (item in classNotesList) {
            if (item.fileName!!.toLowerCase().contains(text.toLowerCase()) ||
                item.subjectName?.toLowerCase()!!.contains(text.toLowerCase()) ||
                item.unitNumber?.toLowerCase()!!.contains(text.toLowerCase()) ||
                item.studentName?.toLowerCase()!!.contains(text.toLowerCase()) ||
                item.fileType?.toLowerCase()!!.contains(text.toLowerCase())) {
